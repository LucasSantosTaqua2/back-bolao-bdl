...
from app.core.database import get\_session, engine, Base \# create\_db\_and\_tables não é mais necessária aqui se chamamos Base.metadata.create\_all
from app.core.config import settings
from app.crud.user import create\_user, get\_user\_by\_username
